...
-------
 ...
 1. Install with [npm](https://www.npmjs.com):`npm install rits-ng-pick-datetime --save`
 2. Add `<link rel="stylesheet" type="text/css" href="/node_modules/rits-pick-datetime/assets/style/picker.min.css" />` in your index.html.
 3. Add __DateTimePickerModule__ import to your __@NgModule__ like example below
  ```js
     ...
     import { DateTimePickerModule } from 'rits-ng-pick-datetime';
  ...
  ```
 4. If you are using __systemjs__ package loader add the following rits-ng-pick-datetime properties to the __System.config__:
```js
  (function (global) {
      System.config({
          paths: {
          ...
          map: {
              ...
              'rits-ng-pick-datetime': 'npm:rits-ng-pick-datetime',
          },
          packages: {
              // Other components are here...

            // the picker
              'rits-ng-pick-datetime': {
...
The picker now separate its styles into **./node_modules/rits-ng-pick-datetime/assets/style/picker.min.css**.
...
**This package originally develop by Daniel YK Pan**