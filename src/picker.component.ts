...
export class DateTimePickerComponent implements OnInit, OnDestroy, ControlValueAccessor {
     ...
     * @return {boolean}
     * */
    public setHoursOnKeyBoard( event: any,  input?: HTMLInputElement ): boolean {
    ...
    public setMinutesOnKeyBoard( event: any,  input?: HTMLInputElement ): boolean {
        if(event.key === "ArrowUp"){
    ...
    public setSecondsOnKeyBoard( event: any,  input?: HTMLInputElement ): boolean {
        if(event.key === "ArrowUp"){
